...
const AI_MODEL = process.env.GEMINI_MODEL || process.env.AI_MODEL || config_1.config.gemini.model || 'google/gemini-2.0-flash';
router.post('/api/xman/chat', async (req, res) => {
    ...
    try {
        ...
        const systemPrompt = xmanPrompt_1.XMAN_SYSTEM_PROMPT + `\n\nCURRENT_STAGE: ${currentStage}`;
